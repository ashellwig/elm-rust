...
var _ashellwig$elm_rust$Main$model = {count: 0, mdl: _debois$elm_mdl$Material$model};
var _ashellwig$elm_rust$Main$Model = F2(
	function (a, b) {
		return {count: a, mdl: b};
	});
var _ashellwig$elm_rust$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _ashellwig$elm_rust$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Increase':
			...
			default:
				return A3(_debois$elm_mdl$Material$update, _ashellwig$elm_rust$Main$Mdl, _p0._0, model);
		}
	});
var _ashellwig$elm_rust$Main$Reset = {ctor: 'Reset'};
var _ashellwig$elm_rust$Main$Increase = {ctor: 'Increase'};
var _ashellwig$elm_rust$Main$view = function (model) {
			...
			},
			{
				...
				_1: {
					...
					_0: A5(
						...
						{
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$onClick(_ashellwig$elm_rust$Main$Increase),
							_1: {
								ctor: '::',
					...
					_1: {
						...
						_0: A5(
							...
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(_ashellwig$elm_rust$Main$Reset),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _ashellwig$elm_rust$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _ashellwig$elm_rust$Main$model, _1: _elm_lang$core$Platform_Cmd$none},
		view: _ashellwig$elm_rust$Main$view,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
		update: _ashellwig$elm_rust$Main$update
	})();
